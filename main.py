...
parser = argparse.ArgumentParser(
                    prog='ecs-tasker',
                    description='Starts/Stops ECS services')
...
parser.add_argument('--verbose', help='Enable verbose mode', action='store_const', dest='loglevel', default=logging.INFO, const=logging.DEBUG)
